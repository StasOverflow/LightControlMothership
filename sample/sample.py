...
class CellImage(wx.StaticBitmap):
    ...
    def __init__(self, parent, path_to_file):
        ...
        super().__init__(
                    parent, -1, self.image, size=(self.image.GetWidth(), self.image.GetHeight())
        )
...
class TestFrame(wx.Frame):
    def __init__(self, *args, **kwargs):
        ...
        self.jpgs = GetJpgList("./static/images")  # get all the jpegs in the Images directory
        self.CurrentJpg = 0
        ...
        # Used to create staticbitmap with an image

        self.png = CellImage(parent=self, path_to_file='./static/images/red_led_button_5.png')

        # wx.Image('./static/images/red_led_button_5.png', wx.BITMAP_TYPE_PNG)
        # # self.png = self.png.Scale(self.MaxImageSize, self.MaxImageSize, wx.IMAGE_QUALITY_HIGH)
        # self.png_bitmap = self.png.ConvertToBitmap()
        # self.display_png = wx.StaticBitmap(
        #             self, -1, self.png_bitmap,
        #             size=(self.png_bitmap.GetWidth(), self.png_bitmap.GetHeight(),)
        # )


        # self.display_png.SetBackgroundColour((240, 240, 240, 255))
        ...
        box.Add((1, 1), 1)
        box.Add(self.png, 0, wx.ALIGN_CENTER_HORIZONTAL | wx.ALL | wx.ADJUST_MINSIZE, 10)
        box.Add((1, 1), 1)
