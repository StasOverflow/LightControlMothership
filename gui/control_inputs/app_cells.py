...
class AppSpecificImageCell(VariableImageCell):
    ...
    def __init__(self, parent, is_input_indication=True,
                 is_conn=False, *args, **kwargs):
        ...
        super().__init__(parent, true_image_path=img_true,
                         false_image_path=img_false, *args, **kwargs)
